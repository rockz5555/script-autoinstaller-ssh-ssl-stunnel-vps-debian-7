...
cat >> "$FILE2" <<EOL
<h1>&#9734; <font color="#20B2AA">PRIVATE SERVER</font> &#9734;</h1>
<h2>
  <font color="#FF6347">𝕊𝕚𝕟𝕘𝕒𝕡𝕠𝕣𝕖</font>
</h2>
<h2>
  <font color="yellow"> ßყ Ɲιʝσσ </font>
</h2>
<h3>
  <font color="lime"> тнιѕ ιѕ ғor perѕoɴαl υѕe αɴd ғor ĸɴowɴ ɢυyѕ oɴly!! </font>
</h3>
🅶🅰🅼🅴 | 🆅🅾🅸🅿 | 🆃🅾🆁🆁🅴🅽🆃
<br />
<h4>
  <font color="cyan">joιɴ мy ɢroυp</font>
  <br />
  <a>https://t.me/NFG_TG</a>
</h4>
EOL
