...
apt-get -y install bmon iftop htop nmap axel nano iptables traceroute dnsutils bc nethogs openvpn vnstat less screen psmisc apt-file whois ptunnel ngrep mtr git zsh mrtg snmp snmpd snmp-mibs-downloader unzip unrar rsyslog debsums rkhunter
...
echo "Timezone : Asia/Colombo"  | tee -a log-install.txt
